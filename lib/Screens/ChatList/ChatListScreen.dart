    ...
    return Scaffold(
        ...
        body: Container(
          child: StreamBuilder<QuerySnapshot>(
            stream: chatFirebaseMethods.fetchContacts(userId: userProvider.getUser!.uid),
              ...
              if(snapshot.hasData){
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ContactModel contactModel = ContactModel.fromMap(docList[index].data() as Map<String,dynamic>);
